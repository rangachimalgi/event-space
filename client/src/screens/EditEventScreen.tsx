...
export default function EditEventScreen({ route, navigation }: any) {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                const response = await axios.get(`https://sincerely-popular-serval.ngrok-free.app/api/events/${eventId}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await axios.put(
                `https://sincerely-popular-serval.ngrok-free.app/api/events/${eventId}`,
                eventData
            );
